    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt>
                            <?= \yii\helpers\Html::a(\yii\helpers\Html::img('http://admin.yiishop.com'.$list->logo),['index/goods','id'=>$list->id])?>

                        </dt>
                        <dd>
                            <?=\yii\helpers\Html::a($list->name,['index/goods','id'=>$list->id]) ?>
                        </dd>
        ...
        <div class="page mt20">
            ...
            echo \yii\widgets\LinkPager::widget([
                ...
                'prevPageLabel'=>'上一页',
                'nextPageLabel'=>'下一页',
                'disabledListItemSubTagOptions'=>['tag'=>'a','style'=>'display:none'],
                'linkOptions'=>['style'=>'float:left']
