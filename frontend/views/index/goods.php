    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="http://admin.yiishop.com.<?=$goods->goods_ablum[0]->img_path?>" class="jqzoom" rel="gal1">

<!--                    <a href="images/preview_l1.jpg" class="jqzoom" rel="gal1">-->
                        <!-- 第一幅图片的大图 class 和 rel属性不能更改-->
                        <?=\yii\helpers\Html::img('http://admin.yiishop.com'.$goods->goods_ablum[0]->img_path,['width'=>'350px','height'=>'350px'])?>
<!--                        <img src="images/preview_m1.jpg" alt="" />               <!-- 第一幅图片的中图-->
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <?php foreach ($goods->goods_ablum as $k=>$album):?>
                                <li<?=$k?'':'class="cur"'?>>
                                    <a <?=$k?'':'class="zoomThumbActive"'?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://admin.yiishop.com<?=$album->img_path?>',largeimage: 'http://admin.yiishop.com<?=$album->img_path?>'}"><?= \yii\helpers\Html::img('http://admin.yiishop.com'.$album->img_path,['width'=>'48px','height'=>'48px'])?></a>
                                </li>
                            <?php endforeach;?>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action='<?=\yii\helpers\Url::to(['/cart/add']) ?>' method="post" class="choose">
                    ...
                    <input type="hidden" neme="_csrf-frontend" id="_csrf-frontends" value=" <?= Yii::$app->request->csrfToken ?>">
                    <ul>
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            ...
                            <li><span>商品编号：</span><?=$goods->sn?></li>
                            <li><span>品牌：</span><?=$goods->brands->name?></li>
                            <li><span>上架时间：</span><?=date('Y-m-d',$goods->create_time)?></li>
